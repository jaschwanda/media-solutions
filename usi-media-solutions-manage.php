...
class USI_Media_Solutions_Manage extends USI_WordPress_Solutions_Settings {
   ...
   function fields_sanitize($input) {
      ...
      if (get_current_user_id()) {
         ...
         // IF delete files tab;
         if ('files' == $_REQUEST['usi-media-manage-tab']) {
            ...
            } // ENDIF user does have permission to delete files;

         // ELSEIF reload files tab;
         } else if ('reload' == $_REQUEST['usi-media-manage-tab']) {
         ...
         // ELSEIF rename files tab;
         } else if ('rename' == $_REQUEST['usi-media-manage-tab']) {
